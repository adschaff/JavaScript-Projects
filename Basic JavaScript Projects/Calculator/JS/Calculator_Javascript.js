...
const Calculator = {
    //This will display 0 on the calcuator screen.
    Display_Value: '0',
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //We are saying that if the Display_value does not contain a decimal
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //if operator exists, property lookup is performer for the operator
...
keys.addEventListener('click', (event) => {
    ...
    //Ensures that AC clears all inputs from the Calcuator screen.
